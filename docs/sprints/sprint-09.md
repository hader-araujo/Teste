# Sprint 9 — Frontend Carrinho + Pedidos + Conta

Frontend do fluxo de pedidos do cliente. Zero endpoints REST novos (backend na Sprint 8).

**Endpoints usados (criados na Sprint 8):**
