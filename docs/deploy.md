...
| `ochefia-pix-expiration` | Job periódico: marca pagamentos PIX com status PENDING há mais de 30min como EXPIRED. Emite `client:payment-cancelled` com `reason: 'expired'` |
