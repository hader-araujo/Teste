...
const MOCK = {
  ...
  products: [
    ...
    { id: 9, name: 'Burger Vegano', desc: 'Hambúrguer de grão-de-bico e beterraba com maionese vegana e salada fresca', price: 38.00, categoryId: 3, destination: 'cozinha', tags: [1], available: true, image: 'https://images.unsplash.com/photo-1520072959219-c595e6cdc07a?w=400&h=300&fit=crop' },
    ...
    { id: 11, name: 'Caipirinha de Limão', desc: 'Caipirinha tradicional com cachaça artesanal, limão tahiti e açúcar', price: 22.00, categoryId: 4, destination: 'bar', tags: [], available: true, image: 'https://images.unsplash.com/photo-1541546006121-e8e0aafc7fc4?w=400&h=300&fit=crop' },
    ...
    { id: 15, name: 'Pudim de Leite', desc: 'Pudim de leite condensado com calda de caramelo, receita da casa', price: 18.00, categoryId: 5, destination: 'cozinha', tags: [], available: true, image: 'https://images.unsplash.com/photo-1528975604071-b4dc52a2d18c?w=400&h=300&fit=crop' }
  ],
